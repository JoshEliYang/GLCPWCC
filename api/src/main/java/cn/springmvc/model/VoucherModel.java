...
public class VoucherModel {
	...
	public String toString() {
		return "VoucherModel [offset=" + offset + ", count=" + count + ", customerCount=" + customerCount
				+ ", voucherValue=" + voucherValue + ", satisfyLimit=" + satisfyLimit + ", filter=" + filter
				+ ", order=" + order + ", promotionIds=" + promotionIds + ", users=" + users + ", timestamp="
				+ timestamp + "]";
	}
